...
-- mirrors 90000_unique_merge_tree_ttl.sql on a replicated pair and
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_90001/r_ttl', '1')
ORDER BY id
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_90001/r_ttl', '2')
ORDER BY id
TTL event_time + INTERVAL 1 DAY;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_90001/r_ttl_mixed', '1')
ORDER BY id
TTL event_time + INTERVAL 1 DAY;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_90001/r_ttl_mixed', '2')
ORDER BY id
TTL event_time + INTERVAL 1 DAY;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_90001/r_ttl_insert', '1')
ORDER BY id
TTL event_time + INTERVAL 1 DAY;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_90001/r_ttl_insert', '2')
ORDER BY id
TTL event_time + INTERVAL 1 DAY;
...
SYSTEM SYNC REPLICA r2_ttl_insert;
OPTIMIZE TABLE r1_ttl_insert FINAL SETTINGS mutations_sync = 2;
SYSTEM SYNC REPLICA r2_ttl_insert;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_90001/r_ttl_part', '1')
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_90001/r_ttl_part', '2')
PARTITION BY toYYYYMM(event_time)
ORDER BY id
TTL event_time + INTERVAL 1 DAY;
...
OPTIMIZE TABLE r2_ttl_part FINAL SETTINGS mutations_sync = 2;
SYSTEM SYNC REPLICA r1_ttl_part;
