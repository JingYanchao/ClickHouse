...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/r_drop_part', '1')
PARTITION BY dt
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/r_drop_part', '2')
PARTITION BY dt
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/r_truncate', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/r_truncate', '2')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/r_drop_dedup', '1')
PARTITION BY dt
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/r_drop_dedup', '2')
PARTITION BY dt
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/r_trunc_dedup', '1')
PARTITION BY dt
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/r_trunc_dedup', '2')
PARTITION BY dt
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/r_drop_all', '1')
PARTITION BY dt
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/r_drop_all', '2')
PARTITION BY dt
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/r_attach', '1')
PARTITION BY dt
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/r_attach', '2')
PARTITION BY dt
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/r_attach_empty', '1')
PARTITION BY dt
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/r_attach_empty', '2')
PARTITION BY dt
ORDER BY id;
