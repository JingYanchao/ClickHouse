...
-- Mirrors 04006_unique_merge_tree_dml INSERT tests but uses ReplicatedUniqueMergeTree.
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/replicated_unique_basic_insert', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/replicated_unique_version_insert', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/replicated_unique_truncate_dml', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/replicated_unique_truncate_ver_dml', '1')
ORDER BY id;
