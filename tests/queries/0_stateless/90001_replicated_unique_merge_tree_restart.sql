...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_90001/replicated_unique_restart_basic', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_90001/replicated_unique_restart_partition', '1')
PARTITION BY dt
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_90001/replicated_unique_restart_replica', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_90001/replicated_unique_restart_replica', '2')
ORDER BY id;
