...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/rep_unique_mutation_update', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/rep_unique_mutation_update_ver', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/rep_unique_mutation_delete', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/rep_unique_mutation_delete_part', '1')
PARTITION BY dt
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/rep_unique_mutation_modify', '1')
ORDER BY id
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/rep_unique_mutation_modify_key', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/rep_unique_mutation_add_col', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/rep_unique_mutation_merge', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/rep_unique_mutation_ver_merge', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/rep_unique_mutation_index', '1')
PARTITION BY id % 2
ORDER BY id
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/rep_unique_mutation_seq', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/rep_unique_mutation_r', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/rep_unique_mutation_r', '2')
ORDER BY id;
