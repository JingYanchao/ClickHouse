...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/replicated_unique_merge_dedup', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/replicated_unique_mutation_dedup', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/replicated_unique_two_replica_merge', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/replicated_unique_two_replica_merge', '2')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/repl_proj_dm', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/repl_proj_dm', '2')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/repl_proj_dm_difforder', '1')
ORDER BY (value, id);
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/repl_proj_dm_difforder', '2')
ORDER BY (value, id);
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/repl_proj_dm_ver', '1')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/repl_proj_dm_ver', '2')
ORDER BY id;
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/repl_proj_dm_verdiff', '1')
ORDER BY (value, id);
...
ENGINE = ReplicatedUniqueMergeTree('/clickhouse/tables/{database}/test_04006/repl_proj_dm_verdiff', '2')
ORDER BY (value, id);
