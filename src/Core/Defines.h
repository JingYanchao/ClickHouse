...
static constexpr auto DEFAULT_SST_READER_CACHE_POLICY = "SLRU";
static constexpr auto DEFAULT_SST_READER_CACHE_MAX_SIZE = 65536uz;
static constexpr auto DEFAULT_SST_READER_CACHE_SIZE_RATIO = 0.5;
